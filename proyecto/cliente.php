    ...
    <form id="formulario" method="post" action="consultas/guardar_usuario.php" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-8">
               ...
               <input type="text" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" name="correo" id="correo" class="form-control form-control-lg" placeholder="Correo electrónico" required>
           ...
           <form id="formulario1"  method="post" action="consultas/guardar_mascota.php"  enctype="multipart/form-data">
              ...
              <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="number" name="documentos" id="documentos" class="form-control form-control-lg" placeholder="ID-Dueño"required readonly>
                </div>
                <div class="col-12">
                    <label for="peso" class="form-label">Peso:</label>
                    <input type="number" name="peso" id="peso" class="form-control form-control-lg" placeholder="Peso en kilogramos"required>
                </div>
                <div class="col-12">
                ...
                <label for="edad" class="form-label">Edad:</label>
                    <input type="number" name="edad" id="direccion" class="form-control form-control-lg" placeholder="Edad en Meses"required>
                </div>
