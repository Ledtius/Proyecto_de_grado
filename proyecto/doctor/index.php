        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card" style="background-color: #B62A50;">
                    <div class="card-body d-flex align-item-center justify-content-between">
                        <img src="descarga.gif" alt="Citas pendientes" style="border-radius: 10px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5); width: 100%; height: 200px;" /> <!-- Imagen para citas pendientes -->
                    </div>
