...
<center><h2 class="custom-title">Citas Programadas</h2></center>
            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><b>Citas Programadas</b></h3>
                    </div>
                    <div class="card-body">
                            ...
                            foreach ($reservas as $reserva){
                                ...
                                <td><?php echo $contador; ?></td>
                                    ...
                                    <td style="text-align: center">
                                        ...
                                        <a href="citas.php?id=<?php echo $reserva['id']; ?>&idmascota=<?php echo $reserva['idmascota']; ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i>Atender</a>
