...
<body class="bg-image">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="profile.php"><i class="dw dw-user1"></i> Profile</a>
                         <a class="dropdown-item" href="register.html"><i class="dw dw-help"></i> Registrar</a>
            ...
            <div class="text-center mt-4 ms-1 me-1">
                <?php
                ...
                <ul id="accordion-menu">
                    ...
                    <li class="dropdown">
                        <a href="usuarios.php" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-archive"></span><span class="mtext">Cliente</span>
                        </a>

                    </li>
                    <li>
                        <a href="calendar.php" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-calendar4-week"></span><span class="mtext">Reservar Citas</span>
                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="cliente.php" class="dropdown-toggle no-arrow">
                            <span class="micon dw dw-edit-2"></span><span class="mtext"> Registro  </span>
                        </a>
        ...
        function searchClients(formData) {
            ...
            fetch('consultas/cedula.php', {
                ...
                .catch(error => {
                   ...
                   document.getElementById('clienteInfo').innerHTML = '<p style="color: red;">EL CLIENTE NO ESTÁ REGISTRADO</p>';
