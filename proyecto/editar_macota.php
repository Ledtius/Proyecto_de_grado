...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($resultado) {
       ...
       header("Location: editar.php?id=$id1");
        ...
        <div class="card-body">
          ...
          <input type="hidden" name="idMascota" value="<?php echo $id2; ?>">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="imagen-mascota" class="form-label">Imagen Mascota</label>
...
<div>
  <section>
    ...
    <button onclick="window.location.href = 'editar.php?id=<?php echo $id1; ?>'" class="btn btn-warning">Volver a cliente</button>
     </div>
      </div>
      <div class="col-md-6">
      <div class="mt-3 text-center">
