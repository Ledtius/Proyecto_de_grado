                    ...
                    <div class="card-body">
                        <form id="formulario" class="row g-3" method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="id_rol" id="id_rol" class="form-control form-control-lg" placeholder="Dirección" value="<?php echo $usuarioarray['id_rol']; ?>" required readonly>
                            </div>
                            <div class="col-md-4">
